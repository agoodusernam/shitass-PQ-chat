...
- RFC 2119: Key words for use in RFCs to Indicate Requirement Levels (see rfc2119.txt in this repository)
...
Rationale: Binary chunk framing avoids JSON re‑encoding overhead and reduces metadata leakage while preserving per‑chunk authentication.
...
11.1 Pre‑verification throttling
