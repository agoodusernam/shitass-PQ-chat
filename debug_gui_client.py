...
class DebugChatGUI(ChatGUI):
    ...
    def set_chain_keys(self):
        ...
        try:
            ...
            tk.Label(dialog, text="Send Chain Key (hex):", bg=self.BG_COLOR, fg=self.FG_COLOR).pack(anchor=tk.W,
                                                                                                    padx=10,
                                                                                                    pady=(10, 0))
            ...
            tk.Label(dialog, text="Receive Chain Key (hex):", bg=self.BG_COLOR, fg=self.FG_COLOR).pack(anchor=tk.W,
                                                                                                       padx=10,
                                                                                                       pady=(10, 0))
